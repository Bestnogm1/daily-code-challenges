...
//fuction should be caled numerb 1
// single numener as an argument
//return numerb + 1
...
function addTwoNumbers (number1, number2) {
  //determin if the parameter is a number or not
  //if they both are numbers add them together and return the sum
  //if one or both are not a number we will retun not retunr NAN
...
//wwrite a function called sumNumbers

function sumNumbers(nums) {
  //creatin a variable to hold our sum of numbers
  var sum = 0;
  //defining the foor loop to cycle through the array and adding nums together
  for(var i = 0; i < nums.length; i++) {
    //[i] accesses the specift idem of the time of the loops [i] = zero
    // += means aary[i]+ =sum
    sum += nums[i];
 ...
 //accepts a the sum of the numbers on the array
...
add(7,-12) //=> -5
-----------------------------------------------------------------------------*/
//write a function called addList
//must take any number as arguments
//add the numebr togerhter
//and return the result
//if the number  retunr 0 
// function addList() {
//   //sum is emrty variabel
//   var sum = 0;
//   //for let suw
